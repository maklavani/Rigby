...
COPY --from=builder --link /var/www/rigby/site/public ./public

# Automatically leverage output traces to reduce image size
# https://nextjs.org/docs/advanced-features/output-file-tracing
# COPY --from=builder --link --chown=1001:1001 /var/www/rigby/site/.next/standalone ./
COPY --from=builder --link --chown=1001:1001 /var/www/rigby/site/.next/static ./.next/static
